 ...
 * @author owen
 */
@TableName(value = "sales_config", autoResultMap = true)
@KeySequence("sales_config_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
...
@NoArgsConstructor
@AllArgsConstructor
public class SalesConfigDO extends BaseDO {
     ...
     * 分佣模式
     * <p>
     * 枚举 {@link SalesBrokerageEnabledConditionEnum 对应的类}
     */
    private Integer brokerageEnabledCondition;
    /**
     * 分销关系绑定模式
     * <p>
     * 枚举 {@link SalesBrokerageBindModeEnum 对应的类}
     */
     ...
     * 提现方式
     * <p>
     * 枚举 {@link SalesBrokerageWithdrawTypeEnum 对应的类}
     */
