 ...
 * @author HUIHUI
 */
@TableName("sales_kefu_conversation")
@KeySequence("sales_kefu_conversation_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
...
@NoArgsConstructor
@AllArgsConstructor
public class SalesKeFuConversationDO extends BaseDO {
     ...
     * 最后发送的消息类型
     *
     * 枚举 {@link SalesKeFuMessageContentTypeEnum}
     */
