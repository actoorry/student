...
import vip.appap.suxin.module.im.controller.admin.vo.ImGroupRequestApplyReqVO;
...
import vip.appap.suxin.module.im.dal.mysql.ImGroupRequestMapper;
import vip.appap.suxin.module.im.enums.ImGroupAddSourceEnum;
import vip.appap.suxin.module.im.enums.ImGroupMemberRoleEnum;
import vip.appap.suxin.module.im.enums.ImGroupRequestHandleResultEnum;
...
import vip.appap.suxin.module.im.service.websocket.dto.notification.group.BaseGroupNotification;
import vip.appap.suxin.module.im.service.websocket.dto.notification.group.GroupRequestApprovedNotification;
import vip.appap.suxin.module.im.service.websocket.dto.notification.group.GroupRequestReceivedNotification;
import vip.appap.suxin.module.im.service.websocket.dto.notification.group.GroupRequestRejectedNotification;
...
public class ImGroupRequestServiceImpl implements ImGroupRequestService {
    ...
    public ImGroupRequestDO applyJoinGroup(Long userId, ImGroupRequestApplyReqVO reqVO) {
        ...
        PartnerRespDTO applyUser = partnerApi.getUser(userId);
    ...
    public void createInviteRequestList(Long groupId, Long inviterUserId, Collection<Long> invitedUserIds) {
        ...
        Map<Long, PartnerRespDTO> userMap = partnerApi.getUserMap(invitedUserIds);
        ...
        for (ImGroupRequestDO request : requests) {
            PartnerRespDTO applyUser = userMap.get(request.getUserId());
            GroupRequestReceivedNotification payload = buildRequestNotification(group, request, applyUser);
