 ...
 * @author 书心软件
 */
public interface SalesCouponService {
     ...
     */
    Map<Long, List<Long>> takeCoupon(Long templateId, Set<Long> userIds, SalesCouponTakeTypeEnum takeType);
    ...
    default Map<Long, List<Long>> takeCouponByAdmin(Long templateId, Set<Long> userIds) {
        return takeCoupon(templateId, userIds, SalesCouponTakeTypeEnum.ADMIN);
    }
    ...
    default void takeCouponByUser(Long templateId, Long userId) {
        takeCoupon(templateId, CollUtil.newHashSet(userId), SalesCouponTakeTypeEnum.USER);
    }
     ...
     * @return 优惠劵分页
     */
    PageResult<SalesCouponDO> getCouponPage(SalesCouponPageReqVO pageReqVO);
     ...
     * @return 优惠劵列表
     */
    List<SalesCouponDO> getCouponList(Long userId, Integer status);
     ...
     * @return 是否可以领取
     */
    Map<Long, Boolean> getUserCanCanTakeMap(Long userId, List<SalesCouponTemplateDO> templates);
     ...
     * @return 优惠劵
     */
    SalesCouponDO getCoupon(Long userId, Long id);
