...
import vip.appap.suxin.module.accountant.framework.pay.core.client.impl.alipay.AlipayAppPayClient;
    ...
    public static class PayClientConfigTypeHandler extends AbstractJsonTypeHandler<Object> {
        ...
        public Object parse(String json) {
            ...
            switch (className) {
                ...
                case "WxVirtualPayClientConfig":
                    return JsonUtils.parseObject2(json, WxVirtualPayClientConfig.class);
