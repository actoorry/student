...
@AllArgsConstructor
@Getter
public enum SalesBannerPositionEnum implements ArrayValuable<Integer> {
    ...
    public static final Integer[] ARRAYS = Arrays.stream(values()).map(SalesBannerPositionEnum::getPosition).toArray(Integer[]::new);
