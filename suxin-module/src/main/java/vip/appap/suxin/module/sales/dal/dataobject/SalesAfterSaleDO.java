...
/**
 * 售后订单，用于处理 {@link SalesOrderDO} 交易订单的退款退货流程
 *
 * @author 书心软件
 */
@TableName(value = "sales_after_sale", autoResultMap = true)
@KeySequence("sales_after_sale_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
public class SalesAfterSaleDO extends BaseDO {
     ...
     * 退款状态
     *
     * 枚举 {@link SalesAfterSaleStatusEnum}
     */
    private Integer status;
    /**
     * 售后方式
     *
     * 枚举 {@link SalesAfterSaleWayEnum}
     */
    private Integer way;
    /**
     * 售后类型
     *
     * 枚举 {@link SalesAfterSaleTypeEnum}
     */
     ...
     * 订单流水号
     *
     * 冗余 {@link SalesOrderDO#getNo()}
     */
    private String orderNo;
    /**
     * 交易订单项编号
     *
     * 关联 {@link SalesOrderItemDO#getId()}
     */
     ...
     * 冗余 {@link SalesOrderItemDO#getSpuId()}
     */
    private Long spuId;
    /**
     * 商品 SPU 名称
     ...
     * 冗余 {@link SalesOrderItemDO#getSpuName()}
     */
     ...
     * 属性数组，JSON 格式
     *
     * 冗余 {@link SalesOrderItemDO#getProperties()}
     */
    @TableField(typeHandler = JacksonTypeHandler.class)
    private List<SalesOrderItemDO.Property> properties;
    /**
     * 商品图片
     *
     * 冗余 {@link SalesOrderItemDO#getPicUrl()}
     */
