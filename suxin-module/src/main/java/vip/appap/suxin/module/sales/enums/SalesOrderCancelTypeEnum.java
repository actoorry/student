...
@Getter
public enum SalesOrderCancelTypeEnum implements ArrayValuable<Integer> {
    ...
    public static final Integer[] ARRAYS = Arrays.stream(values()).map(SalesOrderCancelTypeEnum::getType).toArray(Integer[]::new);
