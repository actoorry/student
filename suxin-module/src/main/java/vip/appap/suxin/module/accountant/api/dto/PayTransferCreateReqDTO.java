...
public class PayTransferCreateReqDTO {
     ...
     *
     * @param jobType 岗位类型
     * @param rewardDescription 报酬说明
     * @return channelExtras
     */
    public static Map<String, String> buildWeiXinChannelExtra1005(String jobType, String rewardDescription) {
        return buildWeiXinChannelExtra(1005,
                "岗位类型", jobType,
                "报酬说明", rewardDescription);
    }
