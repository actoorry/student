 ...
 * @author 书心软件
 */
@TableName(value = "sales_reward_activity", autoResultMap = true)
@KeySequence("sales_reward_activity_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
@EqualsAndHashCode(callSuper = true)
public class SalesRewardActivityDO extends BaseDO {
     ...
     * 条件类型
     *
     * 枚举 {@link SalesConditionTypeEnum}
     */
