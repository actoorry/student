...
@AllArgsConstructor
@Getter
public enum SalesCouponTakeTypeEnum implements ArrayValuable<Integer> {
    ...
    public static final Integer[] ARRAYS = Arrays.stream(values()).map(SalesCouponTakeTypeEnum::getType).toArray(Integer[]::new);
