...
import vip.appap.suxin.module.im.controller.admin.vo.ImPrivateMessageManagerRespVO;
...
public class ImPrivateMessageManagerController {
    ...
    public CommonResult<PageResult<ImPrivateMessageManagerRespVO>> getPrivateMessagePage(
        ...
        Map<Long, PartnerRespDTO> userMap = partnerApi.getUserMap(convertSetByFlatMap(pageResult.getList(),
