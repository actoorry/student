...
import vip.appap.suxin.framework.common.enums.TerminalEnum;
...
public class SalesOrderDO extends BaseDO {
     ...
     * 取消类型
     *
     * 枚举 {@link SalesOrderCancelTypeEnum}
     */
     ...
     * 推广人编号
     *
     * 关联 {@link SalesBrokerageUserDO#getId()} 字段，即 {@link PartnerRespDTO#getId()} 字段
     */
     ...
     * 商品原价，单位：分
     *
     * totalPrice = {@link SalesOrderItemDO#getPrice()} * {@link SalesOrderItemDO#getCount()} 求和
     *
     ...
     * 自提门店编号
     *
     * 关联 {@link SalesDeliveryPickUpStoreDO#getId()}
     */
     ...
     * 售后状态
     *
     * 枚举 {@link SalesOrderRefundStatusEnum}
     */
     ...
     * 秒杀活动编号
     *
     * 关联 SalesSeckillActivityDO 的 id 字段
     */
     ...
     * 砍价活动编号
     *
     * 关联 SalesBargainActivityDO 的 id 字段
     */
    private Long bargainActivityId;
    /**
     * 砍价记录编号
     *
     * 关联 SalesBargainRecordDO 的 id 字段
     */
     ...
     * 积分商城活动的编号
     *
     * 关联 SalesPointActivityDO 的 id 字段
     */
