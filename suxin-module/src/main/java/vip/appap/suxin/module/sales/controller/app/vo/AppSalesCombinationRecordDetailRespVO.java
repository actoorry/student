...
@Data
public class AppSalesCombinationRecordDetailRespVO {

    @Schema(description = "团长的拼团记录", requiredMode = Schema.RequiredMode.REQUIRED)
    private AppSalesCombinationRecordRespVO headRecord;

    @Schema(description = "成员的拼团记录", requiredMode = Schema.RequiredMode.REQUIRED)
    private List<AppSalesCombinationRecordRespVO> memberRecords;
