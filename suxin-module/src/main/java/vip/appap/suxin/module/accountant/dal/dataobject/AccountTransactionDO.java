...
@KeySequence("account_transaction_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
public class AccountTransactionDO extends BaseDO {
     ...
     * 关联业务分类
     *
     * 枚举 {@link AccountBizTypeEnum#getType()}
     */
