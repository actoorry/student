...
public class SalesBargainActivityPageItemRespVO extends SalesBargainActivityBaseVO {
    ...
    @Schema(description = "商品主图", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.appap.vip/xx.png")
