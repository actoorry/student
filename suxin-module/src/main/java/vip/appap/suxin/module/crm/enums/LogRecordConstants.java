package vip.appap.suxin.module.crm.enums;
...
public interface LogRecordConstants {
    ...
    String CRM_CLUE_CREATE_SUCCESS = "创建了线索【{{#clueName}}】";
    ...
    String CRM_CLUE_TRANSFER_SUCCESS = "将线索【{{#clueName}}】的负责人从【{getAdminUserById{#clue.ownerUserId}}】变更为了【{getAdminUserById{#reqVO.newOwnerUserId}}】";
