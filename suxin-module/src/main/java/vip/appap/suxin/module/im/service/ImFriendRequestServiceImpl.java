...
import vip.appap.suxin.module.im.dal.mysql.ImFriendRequestMapper;
import vip.appap.suxin.module.im.enums.ImFriendRequestHandleResultEnum;
import vip.appap.suxin.module.im.enums.ImFriendStateEnum;
...
import vip.appap.suxin.module.im.service.websocket.dto.notification.friend.FriendRequestApprovedNotification;
import vip.appap.suxin.module.im.service.websocket.dto.notification.friend.FriendRequestNotification;
import vip.appap.suxin.module.im.service.websocket.dto.notification.friend.FriendRequestRejectedNotification;
...
public class ImFriendRequestServiceImpl implements ImFriendRequestService {
    ...
    public ImFriendRequestDO applyFriend(Long fromUserId, ImFriendRequestApplyReqVO reqVO) {
        ...
        // 1.2 校验对方存在且启用
        partnerApi.validateUser(toUserId);
        ...
        PartnerRespDTO fromUser = partnerApi.getUser(fromUserId);
