 ...
 * 优惠劵模板 DO
 *
 * 当用户领取时，会生成 {@link SalesCouponDO} 优惠劵
 *
 * @author 书心软件
 */
@TableName(value = "sales_coupon_template", autoResultMap = true)
@KeySequence("sales_coupon_template_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
@EqualsAndHashCode(callSuper = true)
public class SalesCouponTemplateDO extends BaseDO {
     ...
     * 生效日期类型
     *
     * 枚举 {@link SalesCouponTemplateValidityTypeEnum}
     */
    private Integer validityType;
    /**
     * 固定日期 - 生效开始时间
     *
     * 当 {@link #validityType} 为 {@link SalesCouponTemplateValidityTypeEnum#DATE}
     */
     ...
     * 领取日期 - 开始天数
     *
     * 当 {@link #validityType} 为 {@link SalesCouponTemplateValidityTypeEnum#TERM}
     */
