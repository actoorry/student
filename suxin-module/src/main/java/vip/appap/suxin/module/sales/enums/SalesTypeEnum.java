...
@Getter
@AllArgsConstructor
public enum SalesTypeEnum implements ArrayValuable<Integer> {
    ...
    public static final Integer[] ARRAYS = Arrays.stream(values()).map(SalesTypeEnum::getType).toArray(Integer[]::new);
