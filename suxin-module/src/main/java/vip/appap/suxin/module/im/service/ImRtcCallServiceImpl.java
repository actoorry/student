...
import vip.appap.suxin.module.im.controller.admin.vo.ImRtcCallManagerPageReqVO;
import vip.appap.suxin.module.im.controller.admin.vo.ImRtcCallCreateReqVO;
import vip.appap.suxin.module.im.controller.admin.vo.ImRtcCallInviteReqVO;
import vip.appap.suxin.module.im.dal.dataobject.ImRtcCallDO;
import vip.appap.suxin.module.im.dal.dataobject.ImRtcParticipantDO;
import vip.appap.suxin.module.im.dal.mysql.ImRtcCallMapper;
import vip.appap.suxin.module.im.dal.mysql.ImRtcParticipantMapper;
import vip.appap.suxin.module.im.dal.redis.rtc.ImRtcCallLockRedisDAO;
import vip.appap.suxin.module.im.enums.ImConversationTypeEnum;
import vip.appap.suxin.module.im.enums.ImMessageTypeEnum;
import vip.appap.suxin.module.im.enums.ImRtcCallEndReasonEnum;
import vip.appap.suxin.module.im.enums.ImRtcCallStatusEnum;
import vip.appap.suxin.module.im.enums.ImRtcParticipantRoleEnum;
import vip.appap.suxin.module.im.enums.ImRtcParticipantStatusEnum;
import vip.appap.suxin.module.im.framework.config.ImProperties;
import vip.appap.suxin.module.im.framework.rtc.core.LiveKitClient;
import vip.appap.suxin.module.im.framework.rtc.core.LiveKitWebhookEventDTO;
...
import vip.appap.suxin.module.im.service.dto.ImGroupMessageSendDTO;
...
import vip.appap.suxin.module.im.service.websocket.dto.notification.rtc.*;
...
public class ImRtcCallServiceImpl implements ImRtcCallService {
    ...
    private ImRtcCallDO createCall0(Long inviterId, ImRtcCallCreateReqVO reqVO) {
        ...
        PartnerRespDTO inviterUser = partnerApi.getUser(inviterId);
        Map<Long, PartnerRespDTO> inviteeMap = partnerApi.getUserMap(invitees);
        for (Long inviteeId : invitees) {
    ...
    private void addInvitees(ImRtcCallDO call, Long inviterId, Collection<Long> inviteeIds) {
        ...
        PartnerRespDTO inviter = partnerApi.getUser(inviterId);
        Map<Long, PartnerRespDTO> inviteeMap = partnerApi.getUserMap(incomingUserIds);
    ...
    public String signCallToken(Long userId, String room) {
        return signToken(userId, resolveDisplayName(partnerApi.getUser(userId), userId), room);
    }
     ...
     * @param userMap     候选用户预查 map；避免逐个 partnerApi.getUser 走 N+1
     ...
     */
    private void pushCallInviteNotification(ImRtcCallDO call, PartnerRespDTO inviter,
                                            Long inviteeId, PartnerRespDTO invitee,
    ...
    private void pushCallRejectNotification(ImRtcCallDO call, Long operatorUserId) {
        PartnerRespDTO operator = operatorUserId != null ? partnerApi.getUser(operatorUserId) : null;
     ...
     */
    private void pushCallNoAnswerNotification(ImRtcCallDO call, Long operatorUserId, PartnerRespDTO operator) {
     ...
     */
    private void pushCallStartNotification(ImRtcCallDO call, PartnerRespDTO inviter, Set<Long> invitees) {
    ...
    private void pushCallEndNotification(ImRtcCallDO call, Long operatorId, ImRtcCallEndReasonEnum reason,
        ...
        PartnerRespDTO operator = operatorId != null ? partnerApi.getUser(operatorId) : null;
     ...
     * @return 房内显示名
     */
    private static String resolveDisplayName(PartnerRespDTO user, Long userId) {
