package vip.appap.suxin.module.im.service.dto;

import vip.appap.suxin.module.im.enums.ImMessageTypeEnum;
import vip.appap.suxin.module.im.service.websocket.dto.notification.group.*;
...
public class ImGroupMessageSendDTO {
    ...
    public static ImGroupMessageSendDTO ofGroupMessagePin(Long groupId, Long operatorUserId,
                                                          vip.appap.suxin.module.im.dal.dataobject.ImGroupMessageDO message) {
