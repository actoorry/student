package vip.appap.suxin.module.sales.framework.delivery.core.client.impl;
...
import vip.appap.suxin.module.sales.framework.delivery.core.client.impl.kd100.Kd100ExpressClient;
import vip.appap.suxin.module.sales.framework.delivery.core.client.impl.kdniao.KdNiaoExpressClient;
import vip.appap.suxin.module.sales.framework.delivery.core.enums.ExpressClientEnum;
...
public class ExpressClientFactoryImpl implements ExpressClientFactory {
    ...
    private final SalesExpressProperties tradeExpressProperties;
    ...
    private ExpressClient createExpressClient(ExpressClientEnum queryProviderEnum,
                                                SalesExpressProperties tradeExpressProperties) {
