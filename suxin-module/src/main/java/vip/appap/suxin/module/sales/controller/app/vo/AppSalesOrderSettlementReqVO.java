...
@Data
@Valid
public class AppSalesOrderSettlementReqVO {
    ...
    public static class Item {
        ...
        @Schema(description = "购物车项编号", example = "1024")
        private Long cartId;

        @AssertTrue(message = "商品项必须使用 skuId + count 或 cartId")
        @JsonIgnore
        public boolean isValid() {
            if (cartId != null) {
                return true;
            }
            return skuId != null && count != null;
        }
