...
*/
@Data
public class SalesCouponTemplateBaseVO {
    ...
    @InEnum(SalesProductScopeEnum.class)
    ...
    @InEnum(SalesCouponTemplateValidityTypeEnum.class)
    ...
    @InEnum(SalesDiscountTypeEnum.class)
    ...
    public boolean isProductScopeValuesValid() {
        return Objects.equals(productScope, SalesProductScopeEnum.ALL.getScope()) // 全部范围时，可以为空
    ...
    public boolean isValidStartTimeValid() {
        return ObjectUtil.notEqual(validityType, SalesCouponTemplateValidityTypeEnum.DATE.getType())
                || validStartTime != null;
    }
    ...
    public boolean isFixedStartTermValid() {
        return ObjectUtil.notEqual(validityType, SalesCouponTemplateValidityTypeEnum.TERM.getType())
                || fixedStartTerm != null;
    }
    ...
    public boolean isDiscountPercentValid() {
        return ObjectUtil.notEqual(discountType, SalesDiscountTypeEnum.PERCENT.getType())
    ...
    public boolean isDiscountPriceValid() {
        return ObjectUtil.notEqual(discountType, SalesDiscountTypeEnum.PRICE.getType())
                || discountPrice != null;
    }
