 ...
 * @author 陈賝
 */
@TableName("sales_order_log")
@KeySequence("sales_order_log_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
...
@NoArgsConstructor
@AllArgsConstructor
public class SalesOrderLogDO extends BaseDO {
     ...
     * 操作类型
     *
     * {@link SalesOrderOperateTypeEnum}
     */
