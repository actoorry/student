package vip.appap.suxin.module.sales.framework.promotion.web.config;
...
public class SalesPromotionWebConfiguration {
    ...
    public GroupedOpenApi promotionGroupedOpenApi() {
        return SuxinSwaggerAutoConfiguration.buildGroupedOpenApi("promotion");
    }
