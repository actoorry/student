...
@AllArgsConstructor
@Getter
public enum SalesBrokerageRecordBizTypeEnum implements ArrayValuable<Integer> {
    ...
    public static final Integer[] ARRAYS = Arrays.stream(values()).map(SalesBrokerageRecordBizTypeEnum::getType).toArray(Integer[]::new);
