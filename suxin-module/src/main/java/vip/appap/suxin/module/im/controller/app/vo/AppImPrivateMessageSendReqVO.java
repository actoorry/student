...
/**
 * App 端 - 私聊消息发送 Request VO
 */
@Schema(description = "App 端 - 私聊消息发送 Request VO")
@Data
public class AppImPrivateMessageSendReqVO {
    ...
    @Schema(description = "消息内容，JSON 格式", requiredMode = Schema.RequiredMode.REQUIRED, example = "{\"text\":\"你好\"}")
