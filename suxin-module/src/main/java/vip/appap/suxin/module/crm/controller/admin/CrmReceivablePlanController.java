...
import vip.appap.suxin.module.crm.controller.admin.vo.CrmReceivablePlanPageReqVO;
import vip.appap.suxin.module.crm.controller.admin.vo.CrmReceivablePlanRespVO;
import vip.appap.suxin.module.crm.controller.admin.vo.CrmReceivablePlanSaveReqVO;
...
import vip.appap.suxin.module.crm.service.CrmReceivablePlanService;
...
public class CrmReceivablePlanController {
    ...
    private List<CrmReceivablePlanRespVO> buildReceivableDetailList(List<CrmReceivablePlanDO> receivablePlanList) {
        ...
        return BeanUtils.toBean(receivablePlanList, CrmReceivablePlanRespVO.class, (receivablePlanVO) -> {
            // 2.1 拼接客户信息
            findAndThen(customerPartnerMap, receivablePlanVO.getCustomerId(), partner -> receivablePlanVO.setCustomerName(partner.getName()));
            // 2.2 拼接用户信息
