...
import vip.appap.suxin.module.accountant.controller.admin.vo.PayTransferPageReqVO;
...
import vip.appap.suxin.module.accountant.dal.mysql.PayTransferMapper;
    ...
    public PayTransferCreateRespDTO createTransfer(PayTransferCreateReqDTO reqDTO) {
        ...
        if (transfer == null) {
            ...
            transfer = BeanUtils.toBean(reqDTO, PayTransferDO.class)
                    ...
                    .setType(0)
                    .setNotifyUrl(payApp.getTransferNotifyUrl() != null ? payApp.getTransferNotifyUrl()
                            : payProperties.getTransferNotifyUrl());
