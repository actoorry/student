...
@AllArgsConstructor
@Getter
public enum SalesBrokerageWithdrawTypeEnum implements ArrayValuable<Integer> {
    ...
    public static final Integer[] ARRAYS = Arrays.stream(values()).map(SalesBrokerageWithdrawTypeEnum::getType).toArray(Integer[]::new);
