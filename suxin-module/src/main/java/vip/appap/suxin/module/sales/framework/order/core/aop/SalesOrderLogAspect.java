package vip.appap.suxin.module.sales.framework.order.core.aop;
...
@Aspect
@Slf4j
public class SalesOrderLogAspect {
    ...
    @Resource
    private SalesOrderLogService orderLogService;

    @AfterReturning("@annotation(orderLog)")
    public void doAfterReturning(JoinPoint joinPoint, SalesOrderLog orderLog) {
        try {
            // 1.1 操作用户
            ...
            // 2. 记录日志
            SalesOrderLogCreateReqBO createBO = new SalesOrderLogCreateReqBO()
