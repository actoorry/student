...
@Getter
public enum SalesOrderStatusEnum implements ArrayValuable<Integer> {
    ...
    public static final Integer[] ARRAYS = Arrays.stream(values()).map(SalesOrderStatusEnum::getStatus).toArray(Integer[]::new);
