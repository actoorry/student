 ...
 * @author owen
 */
@TableName("sales_brokerage_record")
@KeySequence("sales_brokerage_record_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
...
@NoArgsConstructor
@AllArgsConstructor
public class SalesBrokerageRecordDO extends BaseDO {
     ...
     * 业务类型
     * <p>
     * 枚举 {@link SalesBrokerageRecordBizTypeEnum}
     */
     ...
     * 状态
     * <p>
     * 枚举 {@link SalesBrokerageRecordStatusEnum}
     */
