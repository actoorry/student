...
import vip.appap.suxin.module.accountant.controller.admin.vo.PayNotifyTaskDetailRespVO;
import vip.appap.suxin.module.accountant.controller.admin.vo.PayNotifyTaskPageReqVO;
import vip.appap.suxin.module.accountant.controller.admin.vo.PayNotifyTaskRespVO;
...
import static vip.appap.suxin.module.accountant.enums.ErrorCodeConstants.CHANNEL_NOT_FOUND;

@Tag(name = "管理后台 - 回调通知")
@RestController
@RequestMapping({"/accountant/notify", "/pay/notify"})
@Validated
@Slf4j
