...
@Data
public class AppSalesProductSettlementRespVO {
    ...
    private SalesRewardActivity rewardActivity;
    ...
    public static class Sku implements Serializable {
        ...
        private Integer promotionType; // 对应 SalesTypeEnum 枚举，目前只有 4 和 6 两种
    ...
    @Data
    public static class SalesRewardActivity {
        ...
        private List<SalesRewardActivityRule> rules;

    }

    @Schema(description = "优惠规则")
    @Data
    public static class SalesRewardActivityRule {
