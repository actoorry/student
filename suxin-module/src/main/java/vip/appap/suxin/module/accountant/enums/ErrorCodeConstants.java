...
public interface ErrorCodeConstants {
    ...
    // ========== 微信虚拟支付 1-007-004-000 ==========
    ErrorCode WECHAT_VIRTUAL_PAY_ORDER_NOT_SELF = new ErrorCode(1_007_004_000, "无权操作该支付订单");
    ErrorCode WECHAT_VIRTUAL_PAY_TRADE_ORDER_NOT_FOUND = new ErrorCode(1_007_004_001, "交易订单不存在");
    ErrorCode WECHAT_VIRTUAL_PAY_UNSUPPORTED_PRODUCT_TYPE = new ErrorCode(1_007_004_002, "订单商品暂不支持微信虚拟支付");
    ErrorCode WECHAT_VIRTUAL_PAY_GOODS_NOT_PUBLISHED = new ErrorCode(1_007_004_003, "微信虚拟支付道具未发布");
    ErrorCode WECHAT_VIRTUAL_PAY_MULTIPLE_PRODUCT_ID = new ErrorCode(1_007_004_004, "订单包含多个微信虚拟支付道具，请拆单后支付");
    ErrorCode WECHAT_VIRTUAL_PAY_CHANNEL_CONFIG_ERROR = new ErrorCode(1_007_004_005, "微信虚拟支付渠道配置错误");
    ErrorCode WECHAT_VIRTUAL_PAY_AMOUNT_MISMATCH = new ErrorCode(1_007_004_006, "支付金额与交易订单金额不一致");
    ErrorCode WECHAT_VIRTUAL_PAY_SESSION_KEY_NOT_FOUND = new ErrorCode(1_007_004_007, "微信登录态已失效，请重新登录");
    ErrorCode WECHAT_VIRTUAL_PAY_GOODS_DELIVER_MISMATCH = new ErrorCode(1_007_004_008, "微信虚拟支付回调商品信息不匹配");
    ErrorCode WECHAT_VIRTUAL_PAY_BUY_QUANTITY_INVALID = new ErrorCode(1_007_004_009, "微信虚拟支付购买数量不合法");
    ErrorCode WECHAT_VIRTUAL_PAY_EXTENSION_CONFLICT = new ErrorCode(1_007_004_010, "微信虚拟支付订单信息已变化，请重新下单");
    ErrorCode WECHAT_VIRTUAL_PAY_ORDINARY_CHANNEL_FORBIDDEN = new ErrorCode(1_007_004_011,
            "微信小程序虚拟商品订单只能使用微信虚拟支付，不能使用普通支付渠道");
    ErrorCode WECHAT_VIRTUAL_PAY_REFUND_UNSUPPORTED = new ErrorCode(1_007_004_012,
            "首期暂不支持微信虚拟支付订单在线退款，请联系客服按人工争议流程处理");
    ErrorCode WECHAT_VIRTUAL_PAY_MINIAPP_CONTEXT_REQUIRED = new ErrorCode(1_007_004_013,
            "本期微信虚拟支付仅支持微信小程序");
