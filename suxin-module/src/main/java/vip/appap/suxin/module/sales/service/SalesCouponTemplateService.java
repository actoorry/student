 ...
 * @author 书心软件
 */
public interface SalesCouponTemplateService {
     ...
     * @return 编号
     */
    Long createCouponTemplate(@Valid SalesCouponTemplateCreateReqVO createReqVO);
     ...
     */
    void updateCouponTemplate(@Valid SalesCouponTemplateUpdateReqVO updateReqVO);
     ...
     * @return 优惠劵模板
     */
    SalesCouponTemplateDO getCouponTemplate(Long id);
     ...
     * @return 优惠劵模板分页
     */
    PageResult<SalesCouponTemplateDO> getCouponTemplatePage(SalesCouponTemplatePageReqVO pageReqVO);
     ...
     * @return 优惠券模板列表
     */
    List<SalesCouponTemplateDO> getCouponTemplateListByTakeType(SalesCouponTakeTypeEnum takeType);
     ...
     * @return 优惠券模板列表
     */
    List<SalesCouponTemplateDO> getCouponTemplateList(List<Integer> canTakeTypes, Integer productScope,
     ...
     * @return 优惠券模版列表
     */
    List<SalesCouponTemplateDO> getCouponTemplateList(Collection<Long> ids);
