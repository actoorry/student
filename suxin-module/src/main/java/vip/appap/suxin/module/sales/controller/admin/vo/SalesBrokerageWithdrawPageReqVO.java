...
public class SalesBrokerageWithdrawPageReqVO extends PageParam {

    @Schema(description = "用户编号", example = "11436")
    private Long userId;

    @Schema(description = "提现类型", example = "1")
    @InEnum(value = SalesBrokerageWithdrawTypeEnum.class, message = "提现类型必须是 {value}")
    ...
    @InEnum(value = SalesBrokerageWithdrawStatusEnum.class, message = "状态必须是 {value}")
