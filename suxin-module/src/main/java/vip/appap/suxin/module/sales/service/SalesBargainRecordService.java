 ...
 * @author HUIHUI
 */
public interface SalesBargainRecordService {
     ...
     * @return 砍价记录编号
     */
    Long createBargainRecord(Long userId, AppSalesBargainRecordCreateReqVO reqVO);
     ...
     * @return 砍价信息
     */
    SalesBargainValidateJoinRespDTO validateJoinBargain(Long userId, Long bargainRecordId, Long skuId);
     ...
     * @return 砍价记录
     */
    SalesBargainRecordDO getBargainRecord(Long id);
     ...
     * @return 砍价记录
     */
    SalesBargainRecordDO getLastBargainRecord(Long userId, Long activityId);
     ...
     * @return 砍价记录分页
     */
    PageResult<SalesBargainRecordDO> getBargainRecordPage(SalesBargainRecordPageReqVO pageReqVO);
     ...
     * @return 砍价记录分页
     */
    PageResult<SalesBargainRecordDO> getBargainRecordPage(Long userId, PageParam pageParam);
     ...
     * @return 砍价记录列表
     */
    List<SalesBargainRecordDO> getBargainRecordList(Integer status, Integer count);
