 ...
 * @author HUIHUI
 */
@TableName("sales_bargain_activity")
@KeySequence("sales_bargain_activity_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
...
@NoArgsConstructor
@AllArgsConstructor
public class SalesBargainActivityDO extends BaseDO {
     ...
     * 砍价人数
     *
     * 需要多少人，砍价才能成功，即 {@link SalesBargainRecordDO#getStatus()} 更新为 {@link SalesBargainRecordDO#getStatus()} 成功状态
     */
