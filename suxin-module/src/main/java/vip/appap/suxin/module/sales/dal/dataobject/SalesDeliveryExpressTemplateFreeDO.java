 ...
 * @author jason
 */
@TableName(value ="sales_delivery_express_template_free", autoResultMap = true)
@KeySequence("sales_delivery_express_template_free_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
public class SalesDeliveryExpressTemplateFreeDO extends BaseDO {
