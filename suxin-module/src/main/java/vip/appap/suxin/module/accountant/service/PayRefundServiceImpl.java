...
import vip.appap.suxin.module.accountant.controller.admin.vo.PayRefundExportReqVO;
import vip.appap.suxin.module.accountant.controller.admin.vo.PayRefundPageReqVO;
import vip.appap.suxin.module.accountant.convert.PayRefundConvert;
...
import vip.appap.suxin.module.accountant.dal.mysql.PayRefundMapper;
...
import vip.appap.suxin.module.accountant.service.PayAppService;
import vip.appap.suxin.module.accountant.service.PayChannelService;
import vip.appap.suxin.module.accountant.service.PayNotifyService;
...
public class PayRefundServiceImpl implements PayRefundService {
    ...
    public Long createRefund(PayRefundCreateReqDTO reqDTO) {
        ...
        if (PayChannelEnum.WX_VIRTUAL_LITE.getCode().equals(order.getChannelCode())) {
            throw exception(WECHAT_VIRTUAL_PAY_REFUND_UNSUPPORTED);
        }
        // 1.3 校验支付渠道是否有效
