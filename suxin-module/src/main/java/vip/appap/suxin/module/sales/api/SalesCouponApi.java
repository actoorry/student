 ...
 * @author 书心软件
 */
public interface SalesCouponApi {
     ...
     * @return 优惠劵列表
     */
    List<SalesCouponRespDTO> getCouponListByUserId(Long userId, Integer status);
     ...
     */
    void useCoupon(@Valid SalesCouponUseReqDTO useReqDTO);
