package vip.appap.suxin.module.im.service.websocket.dto.notification.rtc;
...
public class ImRtcCallNotification {
     ...
     * @return INVITE 信令
     */
    public static ImRtcCallNotification ofInvite(ImRtcCallDO call, PartnerRespDTO inviter,
     ...
     * @return REJECT 信令
     */
    public static ImRtcCallNotification ofReject(ImRtcCallDO call, Long operatorUserId, PartnerRespDTO operator) {
     ...
     * @return NO_ANSWER 信令
     */
    public static ImRtcCallNotification ofNoAnswer(ImRtcCallDO call, Long operatorUserId, PartnerRespDTO operator) {
