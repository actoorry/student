...
@Data
public class AppSalesOrderSettlementRespVO {

    @Schema(description = "交易类型", requiredMode = Schema.RequiredMode.REQUIRED, example = "1") // 对应 SalesOrderTypeEnum 枚举
    ...
    @Schema(description = "全部订单项共同支持的配送方式")
    private List<Integer> availableDeliveryTypes;

    /**
     * 营销活动数组
     *
     * 只对应 {@link SalesPriceCalculateRespBO.Price#items} 商品匹配的活动
     */
    private List<SalesPriceCalculateRespBO.Promotion> promotions;
    ...
    public static class Item {
        ...
        @Schema(description = "图片地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.appap.vip/1.png")
        ...
        @Schema(description = "购物车项编号", example = "100")
        private Long cartId;
