...
@AllArgsConstructor
@Getter
public enum SalesAfterSaleStatusEnum implements ArrayValuable<Integer> {
    ...
    public static final Integer[] ARRAYS = Arrays.stream(values()).map(SalesAfterSaleStatusEnum::getStatus).toArray(Integer[]::new);
    ...
    public static SalesAfterSaleStatusEnum valueOf(Integer status) {
