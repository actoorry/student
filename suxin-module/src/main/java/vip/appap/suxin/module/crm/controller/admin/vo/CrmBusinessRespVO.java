...
public class CrmBusinessRespVO {
    ...
    @Schema(description = "创建人名字", example = "书心软件")
    @ExcelProperty("创建人名字")
    ...
    public static class Product {
        ...
        @Schema(description = "产品单价，单位：分", requiredMode = Schema.RequiredMode.REQUIRED, example = "9900")
        private Integer productPrice;

        @Schema(description = "商机价格，单位：分", requiredMode = Schema.RequiredMode.REQUIRED, example = "9900")
        private Integer businessPrice;

        @Schema(description = "产品数量", requiredMode = Schema.RequiredMode.REQUIRED, example = "8911")
        private BigDecimal count;

        @Schema(description = "总计价格，单位：分", requiredMode = Schema.RequiredMode.REQUIRED, example = "99000")
