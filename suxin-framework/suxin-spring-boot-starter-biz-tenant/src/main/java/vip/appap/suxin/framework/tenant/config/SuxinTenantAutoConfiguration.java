package vip.appap.suxin.framework.tenant.config;
...
import vip.appap.suxin.framework.redis.config.SuxinCacheProperties;
...
import vip.appap.suxin.framework.tenant.core.aop.TenantIgnoreAspect;
import vip.appap.suxin.framework.tenant.core.db.TenantDatabaseInterceptor;
import vip.appap.suxin.framework.tenant.core.job.TenantJobAspect;
import vip.appap.suxin.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import vip.appap.suxin.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import vip.appap.suxin.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import vip.appap.suxin.framework.tenant.core.redis.TenantRedisCacheManager;
import vip.appap.suxin.framework.tenant.core.security.TenantSecurityWebFilter;
import vip.appap.suxin.framework.tenant.core.service.TenantFrameworkService;
import vip.appap.suxin.framework.tenant.core.service.TenantFrameworkServiceImpl;
import vip.appap.suxin.framework.tenant.core.web.TenantContextWebFilter;
import vip.appap.suxin.framework.tenant.core.web.TenantVisitContextInterceptor;
...
@AutoConfiguration
@ConditionalOnProperty(prefix = "suxin.tenant", value = "enable", matchIfMissing = true) // 允许使用 suxin.tenant.enable=false 禁用多租户
@EnableConfigurationProperties(TenantProperties.class)
public class SuxinTenantAutoConfiguration {
    ...
    public RedisCacheManager tenantRedisCacheManager(RedisTemplate<String, Object> redisTemplate,
                                                     ...
                                                     SuxinCacheProperties suxinCacheProperties,
                                                     TenantProperties tenantProperties) {
        // 创建 RedisCacheWriter 对象
        RedisConnectionFactory connectionFactory = Objects.requireNonNull(redisTemplate.getConnectionFactory());
        RedisCacheWriter cacheWriter = RedisCacheWriter.nonLockingRedisCacheWriter(connectionFactory,
                BatchStrategies.scan(suxinCacheProperties.getRedisScanBatchSize()));
