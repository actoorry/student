package vip.appap.suxin.framework.web.config;
...
import vip.appap.suxin.framework.web.core.filter.CacheRequestBodyFilter;
import vip.appap.suxin.framework.web.core.filter.DemoFilter;
import vip.appap.suxin.framework.web.core.handler.GlobalExceptionHandler;
import vip.appap.suxin.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class SuxinWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "suxin.demo", havingValue = "true")
