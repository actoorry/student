package vip.appap.suxin.framework.jackson.config;

import vip.appap.suxin.framework.common.util.json.JsonUtils;
import vip.appap.suxin.framework.common.util.json.databind.NumberSerializer;
import vip.appap.suxin.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import vip.appap.suxin.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class SuxinJacksonAutoConfiguration {
