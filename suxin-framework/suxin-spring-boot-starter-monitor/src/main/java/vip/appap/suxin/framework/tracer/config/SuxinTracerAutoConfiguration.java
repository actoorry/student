...
import vip.appap.suxin.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "suxin.tracer", value = "enable", matchIfMissing = true)
public class SuxinTracerAutoConfiguration {
