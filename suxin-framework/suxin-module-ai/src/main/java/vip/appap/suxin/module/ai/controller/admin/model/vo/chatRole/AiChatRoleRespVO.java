package vip.appap.suxin.module.ai.controller.admin.model.vo.chatRole;
...
public class AiChatRoleRespVO implements VO {
    ...
    @Schema(description = "角色头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.appap.vip/1.png")
