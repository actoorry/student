package vip.appap.suxin.module.ai.service.chat;
...
import vip.appap.suxin.framework.tenant.core.util.TenantUtils;
import vip.appap.suxin.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import vip.appap.suxin.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import vip.appap.suxin.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import vip.appap.suxin.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
import vip.appap.suxin.module.ai.dal.dataobject.chat.AiChatConversationDO;
import vip.appap.suxin.module.ai.dal.dataobject.chat.AiChatMessageDO;
import vip.appap.suxin.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import vip.appap.suxin.module.ai.dal.dataobject.model.AiChatRoleDO;
import vip.appap.suxin.module.ai.dal.dataobject.model.AiModelDO;
import vip.appap.suxin.module.ai.dal.dataobject.model.AiToolDO;
import vip.appap.suxin.module.ai.dal.mysql.chat.AiChatMessageMapper;
import vip.appap.suxin.module.ai.enums.ErrorCodeConstants;
import vip.appap.suxin.module.ai.enums.model.AiPlatformEnum;
...
import vip.appap.suxin.module.ai.service.knowledge.AiKnowledgeDocumentService;
import vip.appap.suxin.module.ai.service.knowledge.AiKnowledgeSegmentService;
import vip.appap.suxin.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchReqBO;
import vip.appap.suxin.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchRespBO;
import vip.appap.suxin.module.ai.service.model.AiChatRoleService;
import vip.appap.suxin.module.ai.service.model.AiModelService;
import vip.appap.suxin.module.ai.service.model.AiToolService;
import vip.appap.suxin.module.ai.util.AiUtils;
import vip.appap.suxin.module.ai.util.FileTypeUtils;
...
import static vip.appap.suxin.framework.common.pojo.CommonResult.error;
...
import static vip.appap.suxin.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static vip.appap.suxin.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    @Autowired(required = false) // 由于 suxin.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 suxin.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入
