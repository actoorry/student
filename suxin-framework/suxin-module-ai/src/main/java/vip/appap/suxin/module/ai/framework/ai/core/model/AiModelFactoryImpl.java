package vip.appap.suxin.module.ai.framework.ai.core.model;
...
import vip.appap.suxin.framework.common.util.spring.SpringUtils;
import vip.appap.suxin.module.ai.enums.model.AiPlatformEnum;
import vip.appap.suxin.module.ai.framework.ai.config.AiAutoConfiguration;
import vip.appap.suxin.module.ai.framework.ai.config.SuxinAiProperties;
...
import vip.appap.suxin.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import vip.appap.suxin.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            SuxinAiProperties.Midjourney properties = SpringUtil.getBean(SuxinAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(SuxinAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        SuxinAiProperties.DouBao properties = new SuxinAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(SuxinAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        SuxinAiProperties.HunYuan properties = new SuxinAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(SuxinAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        SuxinAiProperties.SiliconFlow properties = new SuxinAiProperties.SiliconFlow()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(SuxinAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        SuxinAiProperties.XingHuo properties = new SuxinAiProperties.XingHuo()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(SuxinAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        SuxinAiProperties.BaiChuan properties = new SuxinAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(SuxinAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        SuxinAiProperties.Gemini properties = SpringUtil.getBean(SuxinAiProperties.class)
    ...
    private ChatModel buildGrokChatModel(String apiKey,String url) {
        SuxinAiProperties.Grok properties = new SuxinAiProperties.Grok()
                .setBaseUrl(url)
                .setApiKey(apiKey);
