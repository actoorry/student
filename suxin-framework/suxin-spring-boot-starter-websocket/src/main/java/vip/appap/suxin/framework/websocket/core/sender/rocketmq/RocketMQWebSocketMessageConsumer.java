package vip.appap.suxin.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${suxin.websocket.sender-rocketmq.topic}",
        consumerGroup = "${suxin.websocket.sender-rocketmq.consumer-group}",
