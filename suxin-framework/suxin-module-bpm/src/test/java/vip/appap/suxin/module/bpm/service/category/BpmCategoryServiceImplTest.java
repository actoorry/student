package vip.appap.suxin.module.bpm.service.category;

import vip.appap.suxin.framework.common.enums.CommonStatusEnum;
import vip.appap.suxin.framework.common.pojo.PageResult;
import vip.appap.suxin.framework.test.core.ut.BaseDbUnitTest;
import vip.appap.suxin.module.bpm.controller.admin.definition.vo.category.BpmCategoryPageReqVO;
import vip.appap.suxin.module.bpm.controller.admin.definition.vo.category.BpmCategorySaveReqVO;
import vip.appap.suxin.module.bpm.dal.dataobject.definition.BpmCategoryDO;
import vip.appap.suxin.module.bpm.dal.mysql.category.BpmCategoryMapper;
import vip.appap.suxin.module.bpm.service.definition.BpmCategoryServiceImpl;
...
import static vip.appap.suxin.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static vip.appap.suxin.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static vip.appap.suxin.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static vip.appap.suxin.framework.test.core.util.AssertUtils.assertPojoEquals;
import static vip.appap.suxin.framework.test.core.util.AssertUtils.assertServiceException;
import static vip.appap.suxin.framework.test.core.util.RandomUtils.*;
import static vip.appap.suxin.module.bpm.enums.ErrorCodeConstants.CATEGORY_NOT_EXISTS;
