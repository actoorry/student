...
import vip.appap.suxin.framework.test.core.util.AssertUtils;
import vip.appap.suxin.framework.test.core.util.RandomUtils;
import vip.appap.suxin.module.bpm.controller.admin.definition.vo.group.BpmUserGroupSaveReqVO;
import vip.appap.suxin.module.bpm.controller.admin.definition.vo.group.BpmUserGroupPageReqVO;
import vip.appap.suxin.module.bpm.dal.dataobject.definition.BpmUserGroupDO;
import vip.appap.suxin.module.bpm.dal.mysql.definition.BpmUserGroupMapper;
...
import static vip.appap.suxin.module.bpm.enums.ErrorCodeConstants.USER_GROUP_NOT_EXISTS;
...
public class BpmUserGroupServiceTest extends BaseDbUnitTest {
    ...
    public void testGetUserGroupPage() {
       ...
       // 测试 name 不匹配
       userGroupMapper.insert(cloneIgnoreId(dbUserGroup, o -> o.setName("书心")));
       // 测试 status 不匹配
