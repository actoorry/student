...
import vip.appap.suxin.module.bpm.controller.admin.definition.vo.form.BpmFormSaveReqVO;
import vip.appap.suxin.module.bpm.controller.admin.definition.vo.form.BpmFormPageReqVO;
import vip.appap.suxin.module.bpm.dal.dataobject.definition.BpmFormDO;
import vip.appap.suxin.module.bpm.dal.mysql.definition.BpmFormMapper;
import vip.appap.suxin.module.bpm.service.definition.dto.BpmFormFieldRespDTO;
...
import static vip.appap.suxin.module.bpm.enums.ErrorCodeConstants.FORM_NOT_EXISTS;
...
public class BpmFormServiceTest extends BaseDbUnitTest {
    ...
    public void testGetFormPage() {
        ...
        // 测试 name 不匹配
        formMapper.insert(cloneIgnoreId(dbForm, o -> o.setName("软件")));
        // 准备参数
