...
import vip.appap.suxin.module.bpm.controller.admin.task.vo.task.*;
import vip.appap.suxin.module.bpm.convert.task.BpmTaskConvert;
import vip.appap.suxin.module.bpm.dal.dataobject.definition.BpmFormDO;
import vip.appap.suxin.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import vip.appap.suxin.module.bpm.enums.definition.*;
import vip.appap.suxin.module.bpm.enums.task.BpmCommentTypeEnum;
import vip.appap.suxin.module.bpm.enums.task.BpmReasonEnum;
import vip.appap.suxin.module.bpm.enums.task.BpmTaskSignTypeEnum;
...
import vip.appap.suxin.module.bpm.service.definition.BpmFormService;
import vip.appap.suxin.module.bpm.service.definition.BpmModelService;
...
import vip.appap.suxin.module.bpm.service.message.dto.BpmMessageSendWhenTaskTimeoutReqDTO;
...
import static vip.appap.suxin.module.bpm.framework.flowable.core.util.BpmnModelUtils.*;
...
//        }
    ...
    public void rejectTask(Long userId, @Valid BpmTaskRejectReqVO reqVO) {
        ...
        // 疑问：为什么要标记未通过呢？
        // 回答：例如说 A 任务被向前加签除 B 任务时，B 任务被审批不通过，此时 A 会被取消。而 suxin-ui-admin-vue3 不展示“已取消”的任务，导致展示不出审批不通过的细节。
