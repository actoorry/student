package vip.appap.suxin.module.bpm.service.task;
...
import vip.appap.suxin.framework.common.util.object.PageUtils;
import vip.appap.suxin.framework.datapermission.core.annotation.DataPermission;
import vip.appap.suxin.module.bpm.api.task.dto.BpmProcessInstanceCreateReqDTO;
import vip.appap.suxin.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import vip.appap.suxin.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import vip.appap.suxin.module.bpm.controller.admin.task.vo.instance.*;
import vip.appap.suxin.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import vip.appap.suxin.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import vip.appap.suxin.module.bpm.convert.task.BpmProcessInstanceConvert;
import vip.appap.suxin.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import vip.appap.suxin.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import vip.appap.suxin.module.bpm.enums.ErrorCodeConstants;
import vip.appap.suxin.module.bpm.enums.definition.BpmModelTypeEnum;
import vip.appap.suxin.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import vip.appap.suxin.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import vip.appap.suxin.module.bpm.enums.task.BpmReasonEnum;
import vip.appap.suxin.module.bpm.enums.task.BpmTaskStatusEnum;
import vip.appap.suxin.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import vip.appap.suxin.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import vip.appap.suxin.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import vip.appap.suxin.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import vip.appap.suxin.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import vip.appap.suxin.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import vip.appap.suxin.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import vip.appap.suxin.module.bpm.framework.flowable.core.util.FlowableUtils;
import vip.appap.suxin.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import vip.appap.suxin.module.bpm.service.definition.BpmProcessDefinitionService;
import vip.appap.suxin.module.bpm.service.message.BpmMessageService;
...
import static vip.appap.suxin.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static vip.appap.suxin.module.bpm.enums.ErrorCodeConstants.*;
import static vip.appap.suxin.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static vip.appap.suxin.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;
