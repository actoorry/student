package vip.appap.suxin.framework.quartz.core.scheduler;

import vip.appap.suxin.framework.quartz.core.enums.JobDataKeyEnum;
import vip.appap.suxin.framework.quartz.core.handler.JobHandlerInvoker;
import org.quartz.*;
    ...
    private void validateScheduler() {
        if (scheduler == null) {
            throw exception0(NOT_IMPLEMENTED.getCode(),
                    "[定时任务 - 已禁用][参考 https://doc.appap.vip/job/ 开启]");
        }
    }
