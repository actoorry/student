package vip.appap.suxin.module.iot.core.messagebus.config;

import vip.appap.suxin.framework.mq.redis.core.RedisMQTemplate;
import vip.appap.suxin.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import vip.appap.suxin.framework.mq.redis.core.job.RedisStreamMessageCleanupJob;
import vip.appap.suxin.framework.mq.redis.core.stream.AbstractRedisStreamMessage;
import vip.appap.suxin.framework.mq.redis.core.stream.AbstractRedisStreamMessageListener;
import vip.appap.suxin.module.iot.core.messagebus.core.IotMessageBus;
import vip.appap.suxin.module.iot.core.messagebus.core.local.IotLocalMessageBus;
import vip.appap.suxin.module.iot.core.messagebus.core.redis.IotRedisMessageBus;
import vip.appap.suxin.module.iot.core.messagebus.core.rocketmq.IotRocketMQMessageBus;
...
public class IotMessageBusAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "suxin.iot.message-bus", name = "type", havingValue = "local", matchIfMissing = true)
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "suxin.iot.message-bus", name = "type", havingValue = "rocketmq")
    ...
    /**
     * 特殊：由于 SuxinRedisMQConsumerAutoConfiguration 关于 Redis stream 的消费是动态注册，所以这里只能拷贝相关的逻辑！！！
     *
     * @see vip.appap.suxin.framework.mq.redis.config.SuxinRedisMQConsumerAutoConfiguration
     */
    @Configuration
    @ConditionalOnProperty(prefix = "suxin.iot.message-bus", name = "type", havingValue = "redis")
