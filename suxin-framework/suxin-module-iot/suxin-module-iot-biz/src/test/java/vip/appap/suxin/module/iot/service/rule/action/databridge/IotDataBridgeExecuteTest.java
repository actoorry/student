package vip.appap.suxin.module.iot.service.rule.action.databridge;
...
import vip.appap.suxin.module.iot.dal.dataobject.rule.config.*;
import vip.appap.suxin.module.iot.service.rule.data.action.*;
...
public class IotDataBridgeExecuteTest extends BaseMockitoUnitTest {
    ...
    public void testHttpDataBridge() throws Exception {
        ...
        IotDataSinkHttpConfig config = new IotDataSinkHttpConfig()
                .setUrl("https://doc.appap.vip/").setMethod(HttpMethod.GET.name());
