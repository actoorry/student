package vip.appap.suxin.module.iot.api.device;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.ObjUtil;
import cn.hutool.core.util.StrUtil;
import vip.appap.suxin.framework.common.enums.RpcConstants;
...
import vip.appap.suxin.module.iot.core.biz.dto.*;
...
import vip.appap.suxin.module.iot.service.device.IotDeviceModbusConfigService;
...
@RestController
@Validated
@Primary // 保证优先匹配，因为 suxin-iot-gateway 也有 IotDeviceCommonApi 的实现，并且也可能会被 biz 引入
