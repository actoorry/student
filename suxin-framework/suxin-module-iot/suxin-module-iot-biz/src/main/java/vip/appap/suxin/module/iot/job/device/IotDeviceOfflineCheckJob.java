package vip.appap.suxin.module.iot.job.device;
...
import vip.appap.suxin.module.iot.framework.iot.config.SuxinIotProperties;
...
public class IotDeviceOfflineCheckJob implements JobHandler {
    ...
    @Resource
    private SuxinIotProperties iotProperties;
