package vip.appap.suxin.module.iot.gateway.protocol.modbus.tcpserver.handler.upstream;
...
import vip.appap.suxin.module.iot.core.biz.IotDeviceCommonApi;
import vip.appap.suxin.module.iot.core.biz.dto.IotDeviceAuthReqDTO;
import vip.appap.suxin.module.iot.core.biz.dto.IotDeviceRespDTO;
import vip.appap.suxin.module.iot.core.biz.dto.IotModbusDeviceConfigRespDTO;
import vip.appap.suxin.module.iot.core.biz.dto.IotModbusPointRespDTO;
import vip.appap.suxin.module.iot.core.enums.IotDeviceMessageMethodEnum;
import vip.appap.suxin.module.iot.core.enums.modbus.IotModbusFrameFormatEnum;
import vip.appap.suxin.module.iot.core.mq.message.IotDeviceMessage;
import vip.appap.suxin.module.iot.core.topic.IotDeviceIdentity;
import vip.appap.suxin.module.iot.core.util.IotDeviceAuthUtils;
import vip.appap.suxin.module.iot.gateway.protocol.modbus.common.utils.IotModbusCommonUtils;
import vip.appap.suxin.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrame;
import vip.appap.suxin.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrameEncoder;
import vip.appap.suxin.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConfigCacheService;
import vip.appap.suxin.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager;
import vip.appap.suxin.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager.ConnectionInfo;
import vip.appap.suxin.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager;
import vip.appap.suxin.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager.PendingRequest;
import vip.appap.suxin.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPollScheduler;
import vip.appap.suxin.module.iot.gateway.service.device.IotDeviceService;
import vip.appap.suxin.module.iot.gateway.service.device.message.IotDeviceMessageService;
import io.vertx.core.net.NetSocket;
import lombok.extern.slf4j.Slf4j;

import java.util.Map;

import static vip.appap.suxin.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
...
public class IotModbusTcpServerUpstreamHandler {
     ...
     * 处理自定义功能码帧
     * <p>
     * 异常分层翻译，参考 {@link vip.appap.suxin.module.iot.gateway.protocol.http.handler.upstream.IotHttpAbstractHandler}
     */
