package vip.appap.suxin.module.iot.gateway.config;

import vip.appap.suxin.module.iot.core.enums.IotProtocolTypeEnum;
import vip.appap.suxin.module.iot.gateway.protocol.coap.IotCoapConfig;
import vip.appap.suxin.module.iot.gateway.protocol.emqx.IotEmqxConfig;
import vip.appap.suxin.module.iot.gateway.protocol.http.IotHttpConfig;
import vip.appap.suxin.module.iot.gateway.protocol.modbus.tcpclient.IotModbusTcpClientConfig;
import vip.appap.suxin.module.iot.gateway.protocol.modbus.tcpserver.IotModbusTcpServerConfig;
import vip.appap.suxin.module.iot.gateway.protocol.mqtt.IotMqttConfig;
import vip.appap.suxin.module.iot.gateway.protocol.tcp.IotTcpConfig;
import vip.appap.suxin.module.iot.gateway.protocol.udp.IotUdpConfig;
import vip.appap.suxin.module.iot.gateway.protocol.websocket.IotWebSocketConfig;
...
@ConfigurationProperties(prefix = "suxin.iot.gateway")
@Validated
@Data
public class IotGatewayProperties {
    ...
    public static class ProtocolProperties {
         ...
         * 协议类型
         *
         * @see vip.appap.suxin.module.iot.core.enums.IotProtocolTypeEnum
         */
         ...
         * 序列化类型（可选）
         *
         * @see vip.appap.suxin.module.iot.core.enums.IotSerializeTypeEnum
         *
         * 为什么是可选的呢？
