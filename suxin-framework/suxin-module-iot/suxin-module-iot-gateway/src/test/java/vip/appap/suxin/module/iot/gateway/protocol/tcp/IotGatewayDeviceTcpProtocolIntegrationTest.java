...
import vip.appap.suxin.module.iot.core.topic.topo.IotDeviceTopoGetReqDTO;
import vip.appap.suxin.module.iot.core.util.IotDeviceAuthUtils;
import vip.appap.suxin.module.iot.gateway.protocol.tcp.codec.IotTcpCodecTypeEnum;
...
import vip.appap.suxin.module.iot.gateway.serialize.json.IotJsonSerializer;
 ...
 * <p>使用步骤：
 * <ol>
 *     <li>启动 suxin-module-iot-gateway 服务（TCP 端口 8091）</li>
 *     <li>运行以下测试方法：
 *         <ul>
