...
import vip.appap.suxin.module.system.convert.OAuth2OpenConvert;
...
import vip.appap.suxin.module.system.enums.OAuth2GrantTypeEnum;
import vip.appap.suxin.module.system.service.OAuth2ApproveService;
import vip.appap.suxin.module.system.service.OAuth2ClientService;
import vip.appap.suxin.module.system.service.OAuth2GrantService;
...
import static vip.appap.suxin.framework.common.exception.util.ServiceExceptionUtil.exception0;
...
public class OAuth2OpenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", description = "重定向 URI", example = "https://www.appap.vip"),
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", required = true, description = "重定向 URI", example = "https://www.appap.vip"),
