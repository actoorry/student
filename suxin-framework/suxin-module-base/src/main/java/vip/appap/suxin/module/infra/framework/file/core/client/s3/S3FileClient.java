package vip.appap.suxin.module.infra.framework.file.core.client.s3;
...
import vip.appap.suxin.module.infra.framework.file.core.client.AbstractFileClient;
...
public class S3FileClient extends AbstractFileClient<S3FileClientConfig> {
    ...
    private String buildDomain() {
        ...
        if (HttpUtil.isHttp(endpoint) || HttpUtil.isHttps(endpoint)) {
            return StrUtil.format("{}/{}", endpoint, config.getBucket());
        }
        // 阿里云、腾讯云、华为云都适合。七牛云比较特殊，必须有自定义域名
        return StrUtil.format("https://{}.{}", config.getBucket(), endpoint);
    }
