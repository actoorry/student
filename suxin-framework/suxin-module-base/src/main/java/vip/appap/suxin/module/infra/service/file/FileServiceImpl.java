...
import vip.appap.suxin.module.infra.dal.mysql.file.FileMapper;
import vip.appap.suxin.module.infra.framework.file.core.client.FileClient;
import vip.appap.suxin.module.infra.framework.file.core.utils.FileTypeUtils;
...
import static vip.appap.suxin.module.infra.enums.ErrorCodeConstants.FILE_NOT_EXISTS;
...
public class FileServiceImpl implements FileService {
    ...
    public String createFile(byte[] content, String name, String directory, String type) {
        // 委托给新方法，默认值
        return createFile(content, name, directory, type, null, null);
    }
    ...
    public String createFile(byte[] content, String name, String directory, String type,
        ...
        fileMapper.insert(new FileDO().setConfigId(client.getId())
                ...
                .setBizType(bizType)
                .setBizId(bizId));
        // tenantId 由 TenantBaseDO 自动处理（从 TenantContextHolder 获取）
        return url;
    }
    ...
    @Override
    public List<FileDO> getFileListByBiz(String bizType, Long bizId) {
        return fileMapper.selectListByBiz(bizType, bizId);
    }

    @Override
    public List<FileDO> getFileListByBizTypeAndBizIds(String bizType, Collection<Long> bizIds) {
        return fileMapper.selectListByBizTypeAndBizIds(bizType, bizIds);
    }

    @Override
    public int bindFileBizByUrls(String bizType, Long bizId, Collection<String> urls) {
        return fileMapper.updateBizByUrls(bizType, bizId, urls);
    }

    @Override
    public void updateFileAuditStatusByTraceId(String traceId, Integer auditStatus, String auditReason,
                                                LocalDateTime auditTime) {
        fileMapper.updateAuditStatusByTraceId(traceId, auditStatus, auditReason, auditTime);
    }

    @Override
    public Integer getFileAuditStatusByUrl(String url) {
        FileDO file = fileMapper.selectByUrl(url);
        return file != null ? file.getAuditStatus() : null;
    }
