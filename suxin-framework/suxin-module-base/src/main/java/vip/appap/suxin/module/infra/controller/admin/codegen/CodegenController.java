package vip.appap.suxin.module.infra.controller.admin.codegen;
...
import vip.appap.suxin.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import vip.appap.suxin.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import vip.appap.suxin.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import vip.appap.suxin.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import vip.appap.suxin.module.infra.convert.codegen.CodegenConvert;
...
import vip.appap.suxin.module.infra.service.codegen.CodegenService;
...
import static vip.appap.suxin.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname;
import static vip.appap.suxin.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "suxin"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "书心")
    })
