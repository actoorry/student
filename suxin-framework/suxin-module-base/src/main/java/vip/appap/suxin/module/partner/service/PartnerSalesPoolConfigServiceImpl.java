...
import vip.appap.suxin.module.partner.dal.mysql.PartnerSalesPoolConfigMapper;
...
@Service
@Validated
public class PartnerSalesPoolConfigServiceImpl implements PartnerSalesPoolConfigService {

    @Resource
    private PartnerSalesPoolConfigMapper customerPoolConfigMapper;

    @Override
    public PartnerSalesPoolConfigDO getCustomerPoolConfig() {
    ...
    public void saveCustomerPoolConfig(PartnerSalesPoolConfigSaveReqVO saveReqVO) {
        // 1. 存在，则进行更新
        PartnerSalesPoolConfigDO dbConfig = getCustomerPoolConfig();
        PartnerSalesPoolConfigDO poolConfig = BeanUtils.toBean(saveReqVO, PartnerSalesPoolConfigDO.class);
