...
import vip.appap.suxin.module.infra.enums.codegen.CodegenColumnHtmlTypeEnum;
import vip.appap.suxin.module.infra.enums.codegen.CodegenColumnListConditionEnum;
...
public class CodegenBuilder {
    ...
    /**
     * {@link vip.appap.suxin.framework.mybatis.core.dataobject.BaseDO} 的字段
     */
    ...
    private void processColumnExample(CodegenColumnDO column) {
        ...
        if (StrUtil.endWithIgnoreCase(column.getColumnName(), "url")) {
            column.setExample("https://www.appap.vip");
            return;
        }
        // reason
