...
public interface ProductSkuService {
     ...
     * 获得 SKU Map（id → DO）
     */
    default Map<Long, ProductSkuDO> getSkuMap(Collection<Long> ids) {
        return vip.appap.suxin.framework.common.util.collection.CollectionUtils.convertMap(getSkuList(ids), ProductSkuDO::getId);
    }

    /**
     * 校验 SKU 是否存在，不存在抛异常
     */
    ProductSkuDO validateSkuExists(Long id);
