package vip.appap.suxin.module.infra.websocket;
...
import vip.appap.suxin.framework.websocket.core.util.WebSocketFrameworkUtils;
import vip.appap.suxin.module.infra.websocket.message.DemoReceiveMessage;
import vip.appap.suxin.module.infra.websocket.message.DemoSendMessage;
...
public class DemoWebSocketMessageListener implements WebSocketMessageListener<DemoSendMessage> {
    ...
    @Autowired(required = false) // 由于 suxin.websocket.enable 配置项，可以关闭 WebSocket 的功能，所以这里只能不强制注入
