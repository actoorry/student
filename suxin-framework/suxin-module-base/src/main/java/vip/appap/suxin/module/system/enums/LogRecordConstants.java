...
public interface LogRecordConstants {
    ...
    String SYSTEM_USER_CREATE_SUCCESS = "创建了用户【{{#user.username}}】";
    String SYSTEM_USER_UPDATE_SUB_TYPE = "更新用户";
    String SYSTEM_USER_UPDATE_SUCCESS = "更新了用户【{{#user.username}}】: {_DIFF{#updateReqVO}}";
    ...
    String SYSTEM_USER_UPDATE_PASSWORD_SUCCESS = "将用户【{{#user.username}}】的密码从【{{#user.password}}】重置为【{{#newPassword}}】";
