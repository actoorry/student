...
public class ProductSpuRespVO {
    ...
    @Schema(description = "商品封面图", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.appap.vip/xx.png")
    @ExcelProperty("商品封面图")
    private String picUrl;

    @Schema(description = "商品轮播图", requiredMode = Schema.RequiredMode.REQUIRED, example = "[https://www.appap.vip/xx.png, https://www.appap.vip/xxx.png]")
    ...
    @Schema(description = "是否 MES 管理", requiredMode = Schema.RequiredMode.REQUIRED, example = "false")
    @ExcelProperty("MES 管理")
