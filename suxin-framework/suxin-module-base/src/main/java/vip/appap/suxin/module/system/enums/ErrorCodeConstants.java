...
public interface ErrorCodeConstants {
    ...
    ErrorCode PARTNER_NOT_EXISTS = new ErrorCode(1_002_003_012, "合作伙伴不存在");
    ErrorCode PARTNER_ALREADY_BIND_USER = new ErrorCode(1_002_003_013, "合作伙伴已绑定系统用户");
    ...
    ErrorCode SOCIAL_CLIENT_WEIXIN_MINI_APP_MEDIA_CHECK_ERROR = new ErrorCode(1_002_018_206, "调用微信内容安全接口失败：{}");
    ErrorCode SOCIAL_CLIENT_WEIXIN_MINI_APP_OPENID_NOT_FOUND = new ErrorCode(1_002_018_207, "用户未绑定微信小程序");
    ErrorCode SOCIAL_CLIENT_WEIXIN_MINI_APP_ACCESS_EXPIRED = new ErrorCode(1_002_018_208, "用户访问超时，请先访问小程序");
