 ...
 * @author Wanwan
 */
@TableName(value = "partner_crm_limit_config", autoResultMap = true)
@KeySequence("partner_crm_limit_config_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
...
@NoArgsConstructor
@AllArgsConstructor
public class PartnerSalesLimitConfigDO extends BaseDO {
     ...
     * 规则类型
     * <p>
     * 枚举 {@link PartnerSalesLimitConfigTypeEnum}
     */
