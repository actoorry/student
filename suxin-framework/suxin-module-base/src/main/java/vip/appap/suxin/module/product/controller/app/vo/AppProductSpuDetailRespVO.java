...
import vip.appap.suxin.module.product.controller.app.vo.AppProductPropertyValueDetailRespVO;
...
public class AppProductSpuDetailRespVO {
    ...
    @Schema(description = "商品类型", example = "3")
    private Integer type;

    @Schema(description = "是否微信小程序虚拟商品", example = "true")
    private Boolean isWechatMiniappVirtualGoods;

    @Schema(description = "是否需要微信虚拟支付", example = "true")
    private Boolean virtualPaymentRequired;

    @Schema(description = "是否存在可用于微信虚拟支付的 SKU", example = "true")
    private Boolean virtualPaymentReady;

    @Schema(description = "微信虚拟支付不可用原因", example = "微信虚拟支付道具尚未发布")
    private String virtualPaymentUnavailableReason;
    ...
    @Schema(description = "销售分类ID", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
    ...
    @Schema(description = "产品单位编号", example = "102")
    private Long unitId;

    @Schema(description = "产品单位名称", example = "天")
    private String unitName;

    @Schema(description = "配送方式数组", example = "[0, 2]")
    ...
    public static class Sku {
        ...
        @Schema(description = "图片地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.appap.vip/xx.png")
        private String picUrl;
        ...
        @Schema(description = "该 SKU 是否已发布为微信虚拟支付道具", example = "true")
        private Boolean virtualPaymentReady;

        @Schema(description = "该 SKU 不可用于微信虚拟支付的原因", example = "微信虚拟支付道具尚未发布")
        private String virtualPaymentUnavailableReason;
