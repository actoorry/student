...
import vip.appap.suxin.module.partner.enums.PartnerSalesLevelEnum;
import vip.appap.suxin.module.partner.framework.operatelog.core.CrmCustomerIndustryParseFunction;
import vip.appap.suxin.module.partner.framework.operatelog.core.CrmCustomerLevelParseFunction;
import vip.appap.suxin.module.partner.framework.operatelog.core.CrmCustomerSourceParseFunction;
import vip.appap.suxin.module.partner.framework.operatelog.core.SysAreaParseFunction;

import java.time.LocalDateTime;

import static vip.appap.suxin.framework.common.util.date.DateUtils.FORMAT_YEAR_MONTH_DAY_HOUR_MINUTE_SECOND;
import static vip.appap.suxin.module.partner.enums.DictTypeConstants.CRM_CUSTOMER_INDUSTRY;


@Schema(description = "管理后台 - CRM 客户新增/修改 Request VO")
@Data
public class PartnerSalesSaveReqVO {
    ...
    @InEnum(PartnerSalesLevelEnum.class)
