...
public interface ErrorCodeConstants {
    ...
    ErrorCode FILE_AUDIT_PENDING = new ErrorCode(1_001_003_010, "图片审核中，请稍后");
    ErrorCode FILE_AUDIT_REJECTED = new ErrorCode(1_001_003_011, "图片内容不符合规范");
    ErrorCode FILE_AUDIT_FAILED = new ErrorCode(1_001_003_012, "图片审核接口调用失败");
    ErrorCode FILE_FORMAT_NOT_SUPPORTED = new ErrorCode(1_001_003_013, "图片格式不支持，仅支持 jpg, jpeg, png, bmp, gif");
    ErrorCode FILE_SIZE_EXCEEDED = new ErrorCode(1_001_003_014, "文件大小超过限制，单个文件不超过 10M");
