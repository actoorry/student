...
public class AuthLoginReqVO extends CaptchaVerificationReqVO {
    ...
    @Schema(description = "账号", requiredMode = Schema.RequiredMode.REQUIRED, example = "suxinyuanma")
    @NotEmpty(message = "登录账号不能为空")
    @Length(min = SystemValidationConstants.USERNAME_MIN, max = SystemValidationConstants.USERNAME_MAX, message = SystemValidationConstants.USERNAME_LENGTH_MESSAGE)
