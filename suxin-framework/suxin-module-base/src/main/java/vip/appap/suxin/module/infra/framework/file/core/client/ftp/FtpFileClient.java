package vip.appap.suxin.module.infra.framework.file.core.client.ftp;
...
public class FtpFileClient extends AbstractFileClient<FtpFileClientConfig> {
    ...
    public String upload(byte[] content, String path, String type) {
        ...
        reconnectIfTimeout();
        boolean success = ftp.upload(dir, fileName, new ByteArrayInputStream(content)); // 不需要主动创建目录，ftp 内部已经处理（见软件）
        if (!success) {
