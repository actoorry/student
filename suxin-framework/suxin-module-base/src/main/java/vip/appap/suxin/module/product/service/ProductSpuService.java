...
public interface ProductSpuService {
     ...
     * @return SPU 列表
     */
    List<ProductSpuDO> getSpuListByName(String name, Integer limit);
    ...
    /**
     * 通过销售分类 categorySales 查询 SPU 个数
     *
     * @param categorySales 销售分类
     * @return SPU 数量
     */
    Long getSpuCountByCategoryId(Long categorySales);
