...
import vip.appap.suxin.module.product.convert.ProductCommentConvert;
...
import vip.appap.suxin.module.product.dal.mysql.ProductCommentMapper;
...
public class ProductCommentServiceImpl implements ProductCommentService {
    ...
    @Resource
    private PartnerApi memberUserApi;
    ...
    public Long createComment(ProductCommentCreateReqDTO createReqDTO) {
        ...
        // 获取用户详细信息
        PartnerRespDTO user = memberUserApi.getPartner(createReqDTO.getUserId());
