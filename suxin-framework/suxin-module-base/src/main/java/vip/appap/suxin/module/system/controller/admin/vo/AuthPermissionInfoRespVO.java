...
public class AuthPermissionInfoRespVO {
    ...
    public static class UserVO {
        ...
        @Schema(description = "用户头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.appap.vip/xx.jpg")
        ...
        @Schema(description = "用户邮箱", example = "suxin@iocoder.cn")
    ...
    public static class MenuVO {
        ...
        @Schema(description = "菜单名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "书心")
        private Long id;
        ...
        @Schema(description = "过滤参数（JSON 键值对）", example = "{\"status\":1}")
