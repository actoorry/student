package vip.appap.suxin.module.mp.service.account;
...
import vip.appap.suxin.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import vip.appap.suxin.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import vip.appap.suxin.module.mp.convert.account.MpAccountConvert;
import vip.appap.suxin.module.mp.dal.dataobject.account.MpAccountDO;
import vip.appap.suxin.module.mp.dal.mysql.account.MpAccountMapper;
import vip.appap.suxin.module.mp.enums.ErrorCodeConstants;
...
import static vip.appap.suxin.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 suxin-module-mp - 表结构未导入][参考 https://doc.appap.vip/mp/build/ 开启]");
            }
