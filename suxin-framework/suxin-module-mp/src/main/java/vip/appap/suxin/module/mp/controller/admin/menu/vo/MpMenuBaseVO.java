package vip.appap.suxin.module.mp.controller.admin.menu.vo;
...
import static vip.appap.suxin.module.mp.framework.mp.core.util.MpUtils.*;
...
public class MpMenuBaseVO {
    ...
    @Schema(description = "网页链接", example = "https://www.appap.vip/")
