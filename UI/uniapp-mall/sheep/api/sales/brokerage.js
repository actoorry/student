...
const BrokerageApi = {
  ...
  getBrokerageRecordPage: (params) => {
    ...
    const queryString = Object.keys(params)
      ...
      .join('&');
    return request({
      url: `/sales/brokerage-record/page?${queryString}`,
      method: 'GET',
    });
  },
  // 创建分销提现
  ...
  getBrokerageWithdrawPage: (params) => {
    const queryString = Object.keys(params)
      ...
      .join('&');
    return request({
      url: `/sales/brokerage-withdraw/page?${queryString}`,
      method: 'GET',
    });
  },
  // 获得分销提现详情
  ...
  getRankByPrice: (params) => {
    ...
    return request({
      url: `/sales/brokerage-user/get-rank-by-price?${queryString}`,
      method: 'GET',
    });
  },
  // 获得分销用户排行分页（基于佣金）
  getBrokerageUserChildSummaryPageByPrice: (params) => {
    const queryString = Object.keys(params)
      ...
      .join('&');
    return request({
      url: `/sales/brokerage-user/rank-page-by-price?${queryString}`,
      method: 'GET',
    });
  },
  // 获得分销用户排行分页（基于用户量）
  getBrokerageUserRankPageByUserCount: (params) => {
    const queryString = Object.keys(params)
      ...
      .join('&');
    return request({
      url: `/sales/brokerage-user/rank-page-by-user-count?${queryString}`,
      method: 'GET',
    });
  },
  // 获得下级分销统计分页
