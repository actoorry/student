...
export const STANDARD_DIY_COMPONENT_IDS = Object.freeze([
  'SearchBar', 'NoticeBar', 'MenuSwiper', 'MenuTextGrid', 'StickySearchMenuHeader', 'MenuList', 'MenuGrid', 'Popover',
  ...
  'PromotionArticle', 'UserCard', 'UserOrder', 'UserWallet', 'RongjhIdentityBanner',
  'UserCoupon', 'UserAuthButton'
])
