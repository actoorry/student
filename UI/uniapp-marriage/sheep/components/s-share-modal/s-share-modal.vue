    ...
    <su-popup :show="show" round="10" :showClose="false" @close="closeShareModal">
      ...
      <view class="share-box">
        <view class="share-list-box ss-flex">
          ...
          >
            <image class="share-img" :src="sheep.$url.static('/static/img/shop/share/share_friend.svg')" mode="" />
          ...
          >
            <image
              class="share-img"
              :src="sheep.$url.static('/static/img/shop/share/share_poster.svg')"
              mode=""
            />
          ...
          >
            <image class="share-img" :src="sheep.$url.static('/static/img/shop/share/share_link.svg')" mode="" />
