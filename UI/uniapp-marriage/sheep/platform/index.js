...
// 支付服务转发
const pay = (payment, orderType, orderSN, options = {}) => {
  return new Pay(payment, orderType, orderSN, options);
};
...
async function checkNetwork() {
  try {
    ...
    console.warn('[platform] failed to detect network status', error);
    return false;
  }
}
