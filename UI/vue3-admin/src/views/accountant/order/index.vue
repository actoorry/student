<template>
  <doc-alert title="支付宝支付接入" url="https://doc.appap.vip/pay/alipay-pay-demo/" />
  <doc-alert title="微信公众号支付接入" url="https://doc.appap.vip/pay/wx-pub-pay-demo/" />
  <doc-alert title="微信小程序支付接入" url="https://doc.appap.vip/pay/wx-lite-pay-demo/" />
...
import * as OrderApi from '@/api/accountant/order'
...
onMounted(async () => {
  await getList()
  const data = await AppApi.getAppPage({ pageNo: 1, pageSize: 100 })
