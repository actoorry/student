...
import * as PayNotifyApi from '@/api/accountant/notify'
import * as PayAppApi from '@/api/accountant/app'
...
onMounted(async () => {
  await getList()
  // 获得筛选项
  const data = await PayAppApi.getAppPage({ pageNo: 1, pageSize: 100 })
