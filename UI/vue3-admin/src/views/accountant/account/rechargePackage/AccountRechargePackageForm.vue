...
const open = async (type: string, id?: number) => {
  ...
  if (id) {
    ...
    try {
      formData.value = await WalletRechargePackageApi.getAccountRechargePackage(id)
...
const submitForm = async () => {
  ...
  try {
    ...
    if (formType.value === 'create') {
      await WalletRechargePackageApi.createAccountRechargePackage(data)
      message.success(t('common.createSuccess'))
    } else {
      await WalletRechargePackageApi.updateAccountRechargePackage(data)
