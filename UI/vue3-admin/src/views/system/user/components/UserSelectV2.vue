...
const emit = defineEmits<{
  ...
  change: [item: UserApi.PartnerVO | undefined]
}>()
...
// ==================== 名称回显 ====================
const selectedItem = ref<UserApi.PartnerVO | undefined>() // 当前选中的用户对象
...
const resolveItemById = async (id: number | undefined) => {
  ...
  try {
    selectedItem.value = await UserApi.getPartner(id)
  } catch (e) {
...
/** 弹窗选中回调 */
const handleSelected = (rows: UserApi.PartnerVO[]) => {
