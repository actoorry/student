    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['sales:sales_delivery_express:create']"
        >
        ...
        <el-button
          ...
          v-hasPermi="['sales:sales_delivery_express:export']"
        >
      ...
      <el-table-column label="操作" align="center">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['sales:sales_delivery_express:update']"
          >
            编辑
          </el-button>
          <el-button
            ...
            v-hasPermi="['sales:sales_delivery_express:delete']"
          >
            删除
          </el-button>
        </template>
