<template>
  <doc-alert title="【交易】快递发货" url="https://doc.appap.vip/mall/trade-delivery-express/" />
    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['sales:sales_delivery_express_template:create']"
        >
      ...
      <el-table-column label="操作" align="center">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['sales:sales_delivery_express_template:update']"
          >
            编辑
          </el-button>
          <el-button
            ...
            v-hasPermi="['sales:sales_delivery_express_template:delete']"
          >
            删除
          </el-button>
        </template>
...
defineOptions({ name: 'ExpressTemplate' })
