...
import * as CombinationActivityApi from '@/api/sales/promotion/combination/combinationActivity'
import { CombinationProductVO } from '@/api/sales/promotion/combination/combinationActivity'
import { allSchemas, rules } from './combinationActivity.data'
import { SpuAndSkuList, SpuProperty, SpuSelect } from '@/views/sales/promotion/components'
import { getPropertyList, RuleConfig } from '@/views/product/spu/components'
