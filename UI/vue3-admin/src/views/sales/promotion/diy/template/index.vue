<template>
  <doc-alert title="【营销】商城装修" url="https://doc.appap.vip/mall/diy/" />
    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['sales:sales_diy_template:create']"
        >
      ...
      <el-table-column label="操作" align="center" width="200">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['sales:sales_diy_template:update']"
          >
            装修
          </el-button>
          <el-button
          ...
          <template v-if="!scope.row.used">
            <el-button
              ...
              v-hasPermi="['sales:sales_diy_template:use']"
            >
              使用
            </el-button>
            <el-button
              ...
              v-hasPermi="['sales:sales_diy_template:delete']"
            >
              删除
            </el-button>
          </template>
