<template>
  <Dialog v-model="dialogVisible" :title="dialogTitle" width="65%">
    ...
    >
      ...
      >
        <ProductCategorySelect v-model="formData.productCategoryIds" :multiple="true" :parent-id="1" />
      </el-form-item>
...
import * as RewardActivityApi from '@/api/sales/promotion/reward/rewardActivity'
