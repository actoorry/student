...
import { CouponSelect } from '@/views/sales/promotion/coupon/components'
import * as CouponTemplateApi from '@/api/sales/promotion/coupon/couponTemplate'
import { RewardRule } from '@/api/sales/promotion/reward/rewardActivity'
import { DICT_TYPE } from '@/utils/dict'
import { CouponTemplateTakeTypeEnum } from '@/utils/constants'
import { discountFormat } from '@/views/sales/promotion/coupon/formatter'
