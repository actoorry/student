...
import { getBrowseHistoryPage } from '@/api/product/history'
import ProductItem from '@/views/sales/promotion/kefu/components/message/ProductItem.vue'
import { KeFuConversationRespVO } from '@/api/sales/promotion/kefu/conversation'
