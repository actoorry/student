<template>
  <doc-alert title="【营销】优惠劵" url="https://doc.appap.vip/mall/promotion-coupon/" />
  ...
  <ContentWrap>
    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          v-hasPermi="['sales:sales_coupon_template:create']"
          plain
          type="primary"
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      ...
      >
        <template #default="scope">
          <el-button
            v-hasPermi="['sales:sales_coupon_template:update']"
            link
            type="primary"
          ...
          <el-button
            v-hasPermi="['sales:sales_coupon_template:delete']"
            link
            type="danger"
...
import * as CouponTemplateApi from '@/api/sales/promotion/coupon/couponTemplate'
...
import {
  ...
  totalCountFormat,
  validityTypeFormat
} from '@/views/sales/promotion/coupon/formatter'
