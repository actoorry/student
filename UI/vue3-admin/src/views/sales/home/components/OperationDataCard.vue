...
import * as PayStatisticsApi from '@/api/sales/statistics/pay'
...
/** 查询账户充值数据 */
const getAccountRechargeData = async () => {
  const paySummary = await PayStatisticsApi.getAccountRechargePrice()
