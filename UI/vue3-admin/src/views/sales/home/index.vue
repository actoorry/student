<template>
  <doc-alert title="商城手册（功能开启）" url="https://doc.appap.vip/mall/build/" />
...
import * as TradeStatisticsApi from '@/api/sales/statistics/trade'
import * as MemberStatisticsApi from '@/api/sales/statistics/member'
import { DataComparisonRespVO } from '@/api/sales/statistics/common'
import { TradeOrderSummaryRespVO } from '@/api/sales/statistics/trade'
import { MemberCountRespVO } from '@/api/sales/statistics/member'
...
import MemberTerminalCard from '@/views/sales/statistics/member/components/MemberTerminalCard.vue'
import MemberFunnelCard from '@/views/sales/statistics/member/components/MemberFunnelCard.vue'
