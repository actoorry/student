<template>
  <doc-alert title="【统计】会员、商品、交易统计" url="https://doc.appap.vip/mall/statistics/" />
...
import { TradeSummaryRespVO, TradeTrendSummaryRespVO } from '@/api/sales/statistics/trade'
