...
/** 打开弹窗 */
const open = async (row: BrokeragePartnerApi.BrokerageUserVO) => {
  resetForm()
  // 设置数据
...
const submitForm = async () => {
  ...
  try {
    // 发起修改
    await BrokeragePartnerApi.updateBindUser(formData.value)
...
/** 查询推广员 */
const bindUser = ref<BrokeragePartnerApi.BrokerageUserVO>()
const handleGetUser = async () => {
  ...
  formLoading.value = true
  bindUser.value = await BrokeragePartnerApi.getBrokerageUser(formData.value.bindUserId)
  if (!bindUser.value) {
