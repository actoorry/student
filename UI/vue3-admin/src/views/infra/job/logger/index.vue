<template>
  <doc-alert title="定时任务" url="https://doc.appap.vip/job/" />
  <doc-alert title="异步任务" url="https://doc.appap.vip/async-task/" />
  <doc-alert title="消息队列" url="https://doc.appap.vip/message-queue/" />
