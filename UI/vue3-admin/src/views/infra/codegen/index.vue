<template>
  <doc-alert title="代码生成（单表）" url="https://doc.appap.vip/new-feature/" />
  <doc-alert title="代码生成（树表）" url="https://doc.appap.vip/new-feature/tree/" />
  <doc-alert title="代码生成（主子表）" url="https://doc.appap.vip/new-feature/master-sub/" />
  <doc-alert title="单元测试" url="https://doc.appap.vip/unit-test/" />
