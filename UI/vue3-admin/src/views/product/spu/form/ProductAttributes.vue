...
import * as PropertyApi from '@/api/product/property'
import { PropertyAndValues } from '@/views/product/spu/components'
...
const attributeList = ref<PropertyAndValues[]>([]) // 产品属性列表
const attributeOptions = ref([] as PropertyApi.PropertyValueVO[]) // 产品属性名称下拉框
