...
<template>
  <el-form ref="formRef" :model="formData" :rules="rules" label-width="120px" :disabled="isDetail">
    ...
    <el-divider content-position="left">ERP 控制</el-divider>
    <el-form-item label="可销售" prop="isSale">
    ...
    <el-form-item label="可采购" prop="isPurchase">
      <el-radio-group v-model="formData.isPurchase">
        <el-radio :value="true">是</el-radio>
        <el-radio :value="false">否</el-radio>
      </el-radio-group>
    </el-form-item>
    <el-form-item label="MES 管理" prop="isMes">
      <el-radio-group v-model="formData.isMes">
        <el-radio :value="true">是</el-radio>
        <el-radio :value="false">否</el-radio>
      </el-radio-group>
    </el-form-item>
