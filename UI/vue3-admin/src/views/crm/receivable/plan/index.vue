<template>
  <doc-alert title="【回款】回款管理、回款计划" url="https://doc.appap.vip/crm/receivable/" />
...
const customerList = ref<PartnerApi.PartnerVO[]>([]) // 客户列表
...
onMounted(async () => {
  await getList()
  // 获得客户列表
  customerList.value = await PartnerApi.getPartnerSimpleList()
})
</script>
