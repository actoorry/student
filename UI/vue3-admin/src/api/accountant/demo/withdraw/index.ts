...
export const getDemoWithdrawPage = (params: PageParam) => {
  return request.get({ url: '/accountant/demo-withdraw/page', params })
}

// 创建示例提现单
export const createDemoWithdraw = (data: PayDemoWithdrawVO) => {
  return request.post({ url: '/accountant/demo-withdraw/create', data })
}

// 发起提现单转账
export const transferDemoWithdraw = (id: number) => {
  return request.post({ url: '/accountant/demo-withdraw/transfer', params: { id } })
}
